                            ...
                            const std::string& tokenizer_path)
{
    ...
    {
        __android_log_print(ANDROID_LOG_INFO, "Tokkit", "Genie config file not found.");
                           ...
                           const std::string& tokenizer_path)
{
    ...
    {
        __android_log_print(ANDROID_LOG_ERROR, "Tokkit", "Failed to create Genie config.");
    ...
    {
        __android_log_print(ANDROID_LOG_ERROR, "Tokkit", "Failed to create Genie dialog.");
...
GenieWrapper::~GenieWrapper()
{
    if (m_config_handle != nullptr)
    {
        ...
        {
            __android_log_print(ANDROID_LOG_ERROR, "Tokkit", "Failed to free Genie config handler.");
    ...
    if (m_dialog_handle != nullptr)
    {
        ...
        {
            __android_log_print(ANDROID_LOG_ERROR, "Tokkit", "Failed to free Genie dialog handler.");
                                               ...
                                               jmethodID onNewStringMethod)
{
    ...
    {
        __android_log_print(ANDROID_LOG_ERROR, "Tokkit", "Failed to get response from bot.");
    }
    ...
    if (user_data.data.empty())
    {
        ...
        {
            __android_log_print(ANDROID_LOG_ERROR, "Tokkit", "Failed to reset GenieDialog.");
        ...
        if (GENIE_STATUS_SUCCESS != GenieDialog_query(m_dialog_handle, user_prompt.c_str(),
                                                      ...
                                                      GenieCallBack, &user_data))
        {
            __android_log_print(ANDROID_LOG_INFO, "Tokkit", "Error getting response from Genie.");
