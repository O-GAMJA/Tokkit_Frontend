...
extern "C" JNIEXPORT jlong JNICALL Java_com_example_tokkit_genie_GenieWrapper_loadModel(JNIEnv* env,
                                                                                   jobject /* this */,
...
extern "C" JNIEXPORT void JNICALL Java_com_example_tokkit_genie_GenieWrapper_getResponseForPrompt(JNIEnv* env,
                                                                                                  jobject /* this */,
...
extern "C" JNIEXPORT void JNICALL Java_com_example_tokkit_genie_GenieWrapper_freeModel(JNIEnv* env,
                                                                                  jobject /* this */,
                                                                                  jlong genie_wrapper_handle)
{
    try
