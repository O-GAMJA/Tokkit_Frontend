...
public class GenieWrapper {
     ...
     */
    public void getResponseForPrompt(String userInput, com.example.tokkit.genie.StringCallback callback) {
     ...
     * @param callback callback to tunnel each generated token to
     */
    private native void getResponseForPrompt(long nativeHandle, String userInput, com.example.tokkit.genie.StringCallback callback);
